  ...
  return (
    <section id="contact" className="px-4 md:px-16 py-16 md:py-24 bg-surface">
      <div className="max-w-2xl mx-auto">
        <h2 className="text-2xl md:text-4xl font-semibold text-text mb-3">Get in touch</h2>
        ...
        {done ? (
          <div className="bg-background border border-border rounded-2xl p-8 text-center">
            ...
            <p className="text-text font-medium text-lg">Message sent!</p>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label htmlFor="contact-name" className="text-sm text-muted mb-1 block">Name</label>
                <input
                  id="contact-name"
                  type="text"
                  value={form.name}
              ...
              <div>
                <label htmlFor="contact-email" className="text-sm text-muted mb-1 block">Email</label>
                <input
                  id="contact-email"
                  type="email"
                  value={form.email}
            ...
            <div>
              <label htmlFor="contact-message" className="text-sm text-muted mb-1 block">Message</label>
              <textarea
                id="contact-message"
                value={form.message}
