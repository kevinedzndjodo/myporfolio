...
function Hero() {
    ...
    return (
        <section id="home" className="min-h-[80vh] lg:min-h-screen lg:h-full flex flex-col justify-center lg:justify-between gap-8 lg:gap-0 px-4 md:px-16 py-8 md:py-8 bg-background overflow-hidden">
            <div ref={contentRef} className="flex flex-col justify-center lg:justify-between h-full gap-8 lg:gap-0">
                ...
                <div>
                    ...
                    <a href="#overview"
                        className="group inline-flex items-center justify-center gap-2 mt-6 md:mt-8 bg-accent text-background px-5 py-3 md:px-6 md:py-3 rounded-md font-medium text-sm md:text-base overflow-hidden relative w-full md:w-fit"
                    >
